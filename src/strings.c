...
const u8 gText_ExpandedPlaceholder_Aqua[] = _("BAND");
const u8 gText_ExpandedPlaceholder_Magma[] = _("ROBOTICS");
const u8 gText_ExpandedPlaceholder_Archie[] = _("CASSIE");
const u8 gText_ExpandedPlaceholder_Maxie[] = _("OLLIE");
...
const u8 gText_Brawly[] = _("CECELY");
const u8 gText_Winona[] = _("ELIJAH");
const u8 gText_Phoebe[] = _("JULIETTE");
const u8 gText_Glacia[] = _("V");
