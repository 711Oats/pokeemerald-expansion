...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    TRAINER_CLASS(TEAM_AQUA, "TEAM BAND"),
    ...
    TRAINER_CLASS(TEAM_MAGMA, "ROBOTICS"),
    TRAINER_CLASS(EXPERT, "EXPERT", 10),
    TRAINER_CLASS(AQUA_ADMIN, "BAND ADMIN", 10),
    TRAINER_CLASS(BLACK_BELT, "BLACK BELT", 8, ITEM_ULTRA_BALL),
    TRAINER_CLASS(AQUA_LEADER, "BAND LEADER", 20, ITEM_MASTER_BALL),
